...
impl Status {
    ...
    fn decode_from(r: &mut _baproto::BitReader) -> Result<Self, _baproto::DecodeError> {
        let discriminant = r.read_bits(8)?;
        match discriminant {
            0 => Ok(Self::Unknown),
            1 => Ok(Self::Active),
            2 => Ok(Self::Inactive),
            _ => Err(_baproto::DecodeError::InvalidDiscriminant { value: discriminant, type_name: "Status" }),
        }
    }
}
...
impl Tagged {
    ...
    fn decode_from(r: &mut _baproto::BitReader) -> Result<Self, _baproto::DecodeError> {
        ...
        match discriminant {
            0 => Ok(Self::None),
            1 => {
                Ok(Self::Number(r.read_bits(32)? as u32))
            }
            2 => {
            ...
            _ => Err(_baproto::DecodeError::InvalidDiscriminant { value: discriminant, type_name: "Tagged" }),
        }
    }
}
...
impl WithEnum {
    ...
    /// Internal decoding using BitReader.
    fn decode_from(r: &mut _baproto::BitReader) -> Result<Self, _baproto::DecodeError> {
        let status = Status::decode_from(r)?;
        let status = Status::decode_from(r)?;
        let value = Tagged::decode_from(r)?;
        let value = Tagged::decode_from(r)?;
        Ok(Self {
            status,
            status,
