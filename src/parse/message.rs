...
mod tests {
    ...
    fn test_message_empty_body_succeeds() {
        ...
        let (msg, errors): (Option<ast::Message>, _) =
            test_parse!(input, message(parse::MAX_RECURSION_DEPTH));
    ...
    fn test_field_index_zero_succeeds() {
        ...
        // When: The input is parsed.
        let (index, errors): (Option<ast::FieldIndex>, _) = test_parse!(input, field_index());

        // Then: Parsing succeeds.
        assert!(errors.is_empty(), "unexpected errors: {:?}", errors);
        let index = index.expect("should have output");
    ...
    fn test_field_index_missing_colon_fails() {
        ...
        // When: The input is parsed.
        let (_result, errors): (Option<ast::FieldIndex>, _) = test_parse!(input, field_index());
