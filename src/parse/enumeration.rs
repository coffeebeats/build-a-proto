...
mod tests {
    ...
    fn test_enumeration_missing_name_fails() {
        ...
        assert_parse_fails(parse_single(input, enumeration()));
    }
    ...
    fn test_enumeration_empty_body_succeeds() {
        ...
        // When: The input is parsed.
        let enumeration = assert_parse_succeeds(parse_single(input, enumeration()));
    ...
    fn test_enumeration_with_comment_block_item_succeeds() {
        ...
        assert_eq!(
            v2.comment.as_ref().unwrap().comments[0].content,
            "Internal separator"
        );
    }
    ...
    fn test_enumeration_mixed_item_types_succeeds() {
        ...
        assert_eq!(
            v1.comment.as_ref().unwrap().comments[0].content,
            "Header comment"
        );
